...
<p><strong>We just begin formulating this list, and are actively expanding it.</strong> The individuals considered here meet two criteria: (i) they completed at least one of their bachelor's, master's, or PhD degrees at Fudan University, and (ii) they are currently professors (either tenured or not-tenured) at universities other than Fudan. Note: Fudan students can contact any Fudan professors on campus, so we have chosen not to include them in this list.</p>
