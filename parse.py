...
<p>We just begin formulating this list, and are actively expanding it. The individuals considered here meet two criteria: (i) they completed at least one of their bachelor's, master's, or PhD degrees at Fudan University, and (ii) they are currently professors (either tenured or not-tenured) at universities other than Fudan. Note: Fudan students can contact any Fudan professors on campus, so we have chosen not to include them in this list.</p>

<p><strong>We are seeking a group of volunteers to maintain and update this list<\strong>. If you are interested, please get in touch with us via email at <a href="mailto:fgfc23.start@gmail.com">fgfc23.start@gmail.com</a>.</p>
